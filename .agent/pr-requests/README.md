# Repository-owned PR requests

이 디렉터리는 Issue-driven 구현에서 실제로 사용하는 축약된 PR 요청서를 보관한다.

- 템플릿: `.agent/PR_REQUEST_TEMPLATE.md`
- 실제 요청서 이름: `PR-NNN-<slug>.md`
