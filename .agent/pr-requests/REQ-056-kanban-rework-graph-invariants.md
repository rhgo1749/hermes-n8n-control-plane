# REQ-056: Kanban Rework Graph Invariant 및 GitHub-backed 완료 판정 계약 강화
...
- Request path: `.agent/pr-requests/REQ-056-kanban-rework-graph-invariants.md`
- Merge authority: Human/user only
- Source issue: `rhgo1749/hermes-n8n-control-plane#56`
...
- In scope:
  - `docs/KANBAN_ROLE_CONTRACTS.md`: Rework graph invariant 및 GitHub-backed completion boundary 상세 명문화.
...
- [x] `docs/KANBAN_ROLE_CONTRACTS.md`에 Rework graph invariant 및 non-terminal parent 방지 규칙이 명시됨.
