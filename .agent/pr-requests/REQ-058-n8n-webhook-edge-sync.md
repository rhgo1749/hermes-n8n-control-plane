...
- Source-of-truth base: `origin/main` @ `d168ca5d659e247f88c1ff00c2291be4e2f6342b`
...
- Kanban task ID: `t_d91e085f` (parent `t_a6243210`)
...
bounded, private n8n Webhook workflow. The workflow filters and normalizes only
...
5. Update the event, operations, registry, and completion documentation plus this
   request file.
